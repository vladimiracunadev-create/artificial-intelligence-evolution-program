...
# Teoría — Clustering y reducción de dimensionalidad
...
`Clustering y reducción de dimensionalidad` se estudia como un sistema con:
...
Conceptos guía: **KMeans, DBSCAN, PCA, embeddings**.
