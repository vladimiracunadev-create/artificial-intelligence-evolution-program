...
# Teoría — Ingeniería y selección de características
...
`Ingeniería y selección de características` se estudia como un sistema con:
...
Conceptos guía: **features, encoding, selección, pipelines**.
