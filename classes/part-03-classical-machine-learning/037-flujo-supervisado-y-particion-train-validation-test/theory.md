...
# Teoría — Flujo supervisado y partición train-validation-test
...
`Flujo supervisado y partición train-validation-test` se estudia como un sistema con:
...
Conceptos guía: **supervisado, split, fuga, baseline**.
