...
# Teoría — Proyecto: producto ML reproducible
...
`Proyecto: producto ML reproducible` se estudia como un sistema con:
...
Conceptos guía: **pipeline, baseline, validación, serving**.
