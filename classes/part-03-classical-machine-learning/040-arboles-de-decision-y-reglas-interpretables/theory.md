...
# Teoría — Árboles de decisión y reglas interpretables
...
`Árboles de decisión y reglas interpretables` se estudia como un sistema con:
...
Conceptos guía: **árboles, impureza, poda, reglas**.
