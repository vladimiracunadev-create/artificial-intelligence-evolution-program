...
# Teoría — Regresión lineal, regularización y diagnóstico
...
`Regresión lineal, regularización y diagnóstico` se estudia como un sistema con:
...
Conceptos guía: **regresión, L1, L2, residuos**.
