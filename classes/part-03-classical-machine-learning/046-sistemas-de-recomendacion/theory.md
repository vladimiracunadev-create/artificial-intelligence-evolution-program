...
# Teoría — Sistemas de recomendación
...
`Sistemas de recomendación` se estudia como un sistema con:
...
Conceptos guía: **filtrado colaborativo, contenido, ranking, cold-start**.
