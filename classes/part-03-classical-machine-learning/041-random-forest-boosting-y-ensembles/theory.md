...
# Teoría — Random Forest, boosting y ensembles
...
`Random Forest, boosting y ensembles` se estudia como un sistema con:
...
Conceptos guía: **ensembles, bagging, boosting, diversidad**.
