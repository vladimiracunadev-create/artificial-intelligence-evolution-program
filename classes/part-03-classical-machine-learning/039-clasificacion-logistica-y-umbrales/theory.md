...
# Teoría — Clasificación logística y umbrales
...
`Clasificación logística y umbrales` se estudia como un sistema con:
...
Conceptos guía: **logística, probabilidades, umbral, calibración**.
