...
> [← Clase anterior](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/147-registro-y-promocion-champion-challenger/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/149-serving-online-batch-y-streaming/README.md)
...
clase 145, usando el registro de la 147 como puerta de salida hacia el serving (149).
...
2. **Tests de modelo**: el artefacto entrenado es apto.
   ...
   - Reproducibilidad del entrenamiento (semilla + snapshot, clase 146).
...
6. registro del candidato (challenger) (clase 147)
...
[147 — Registro y promoción champion-challenger](../../part-12-ai-engineering-mlops-llmops-and-agentops/147-registro-y-promocion-champion-challenger/README.md)
