...
# Teoría — CI/CD y pruebas para sistemas de IA
...
`CI/CD y pruebas para sistemas de IA` se estudia como un sistema con:
...
Conceptos guía: **CI, tests, validation, contracts**.
