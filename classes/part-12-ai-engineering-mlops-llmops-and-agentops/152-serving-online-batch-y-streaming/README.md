...
> [← Clase anterior](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/151-ci-cd-y-pruebas-para-sistemas-de-ia/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/153-observabilidad-logs-metricas-y-trazas/README.md)
...
Un modelo registrado y probado (clases 150-151) todavía no sirve a nadie: falta decidir
...
sigue: qué se puede observar (153), qué deriva se detecta y cuándo (154) y cuánto cuesta
operar (157). Elegir mal aquí es caro de revertir: cambia la arquitectura completa.
