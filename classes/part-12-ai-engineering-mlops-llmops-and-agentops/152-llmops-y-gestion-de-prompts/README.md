...
> [← Clase anterior](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/151-deriva-feedback-y-evaluacion-continua/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/153-agentops-y-analisis-de-trayectorias/README.md)
...
la convierte en proceso operado, preparando el terreno de AgentOps (153).
...
Principios heredados del registro de modelos (147): versiones **inmutables** (v12 no se
...
producción registra `prompt_version` en su span (clase 150).

### 🧪 Evals de regresión

Editar un prompt es editar código sin compilador: la única red es una **suite de evals**
que corre antes de publicar, como los tests en CI (148):
