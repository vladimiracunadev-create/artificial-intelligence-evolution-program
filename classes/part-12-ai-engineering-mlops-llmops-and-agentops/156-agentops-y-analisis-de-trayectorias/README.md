...
**Normas y documentación oficial que aplica esta clase:** [OpenTelemetry](https://opentelemetry.io/docs/specs/semconv/gen-ai/) · [Model Context Protocol](https://modelcontextprotocol.io)
<!-- bibliografia:fin -->
