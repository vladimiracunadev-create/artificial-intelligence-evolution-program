...
# Teoría — Ciclo de vida de datos, modelos y agentes
...
`Ciclo de vida de datos, modelos y agentes` se estudia como un sistema con:
...
Conceptos guía: **lifecycle, data, model, agent**.
