...
> [← Clase anterior](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/146-experimentos-semillas-y-trazabilidad/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/148-ci-cd-y-pruebas-para-sistemas-de-ia/README.md)
...
Con experimentos trazables (clase 146) el problema pasa a ser de gobierno: ¿qué versión
...
acordadas de antemano. Es la antesala del CI/CD (148) y del serving (149).
