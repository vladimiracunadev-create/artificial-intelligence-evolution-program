...
# 155 — Resiliencia, idempotencia, rollback y recuperación

> [← Clase anterior](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/154-costo-latencia-caching-y-capacidad/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/156-proyecto-plataforma-de-ia-observable/README.md)
...
economía de la clase 154 (un reintento mal diseñado duplica costo y latencia) y
...
- **Rollback de despliegue**: volver a la versión anterior (modelo, prompt,
  ...
  (clase 147), despliegue gradual con baseline (canary), y datos compatibles
...
telemetría real (clase 150), cada reintento se registra con su costo (clase
