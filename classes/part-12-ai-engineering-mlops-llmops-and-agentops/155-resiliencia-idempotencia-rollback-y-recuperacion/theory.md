...
# Teoría — Resiliencia, idempotencia, rollback y recuperación
...
`Resiliencia, idempotencia, rollback y recuperación` se estudia como un sistema con:
...
Conceptos guía: **resilience, idempotency, rollback, recovery**.
