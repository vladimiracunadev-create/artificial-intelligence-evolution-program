...
> [← Clase anterior](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/152-llmops-y-gestion-de-prompts/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/154-costo-latencia-caching-y-capacidad/README.md)
...
herramientas, observa y vuelve a decidir (parte 09). AgentOps extiende LLMOps (152) a ese
objeto más difícil: ya no se evalúa una salida, sino un **camino completo** con longitud
variable, costo variable y efectos en el mundo. Sus trazas son las de la clase 150 con
semántica extra, y sus métricas son las que el proyecto integrador (156) tendrá que
exponer en un panel.
...
- **Replay**: re-ejecutar la misma tarea contra una configuración nueva (prompt de
  sistema, set de herramientas) — el champion-challenger (147) aplicado a agentes, con
...
[152 — LLMOps y gestión de prompts](../../part-12-ai-engineering-mlops-llmops-and-agentops/152-llmops-y-gestion-de-prompts/README.md)

## ➡️ Siguiente clase

[154 — Costo, latencia, caching y capacidad](../../part-12-ai-engineering-mlops-llmops-and-agentops/154-costo-latencia-caching-y-capacidad/README.md)
