...
# Teoría — AgentOps y análisis de trayectorias
...
`AgentOps y análisis de trayectorias` se estudia como un sistema con:
...
Conceptos guía: **AgentOps, trajectories, tools, traces**.
