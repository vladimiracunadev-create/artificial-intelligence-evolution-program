...
# 156 — Proyecto: plataforma de IA observable

> [← Clase anterior](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/155-resiliencia-idempotencia-rollback-y-recuperacion/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-13-evaluation-safety-security-and-governance/157-diseno-de-evaluaciones-y-criterios-de-exito/README.md)
...
las piezas de las clases 145-155 como un pipeline único:
...
| Respuesta | rollback a v11 en minutos (artefacto inmutable, 155) + análisis de trayectorias (153) | causa: nuevo tipo de consulta, no v12 |
...
4. **«Las evals offline garantizan la calidad online.»** El tráfico real
   deriva (151); las evals offline son condición necesaria de promoción, no
...
[155 — Resiliencia, idempotencia, rollback y recuperación](../../part-12-ai-engineering-mlops-llmops-and-agentops/155-resiliencia-idempotencia-rollback-y-recuperacion/README.md)

## ➡️ Siguiente clase

[157 — Diseño de evaluaciones y criterios de éxito](../../part-13-evaluation-safety-security-and-governance/157-diseno-de-evaluaciones-y-criterios-de-exito/README.md)
