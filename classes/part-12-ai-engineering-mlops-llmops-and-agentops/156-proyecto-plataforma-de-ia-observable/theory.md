...
# Teoría — Proyecto: plataforma de IA observable
...
`Proyecto: plataforma de IA observable` se estudia como un sistema con:
...
Conceptos guía: **platform, observability, release, SLO**.
