...
# Teoría — Experimentos, semillas y trazabilidad
...
`Experimentos, semillas y trazabilidad` se estudia como un sistema con:
...
Conceptos guía: **experiments, seeds, lineage, artifacts**.
