...
# Teoría — Observabilidad: logs, métricas y trazas
...
`Observabilidad: logs, métricas y trazas` se estudia como un sistema con:
...
Conceptos guía: **logs, metrics, traces, OTel**.
