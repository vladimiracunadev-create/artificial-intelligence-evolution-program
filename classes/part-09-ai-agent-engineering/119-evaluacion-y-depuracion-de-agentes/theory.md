...
# Teoría — Evaluación y depuración de agentes
...
`Evaluación y depuración de agentes` se estudia como un sistema con:
...
Conceptos guía: **trajectory, tool calls, success, regression**.
