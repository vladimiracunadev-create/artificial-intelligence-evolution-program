...
> [← Clase anterior](../../../classes/part-09-ai-agent-engineering/118-presupuestos-de-pasos-tokens-costo-y-tiempo/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-09-ai-agent-engineering/120-proyecto-agente-individual-operativo/README.md)
...
lo construido — trazas (111), planes (112), permisos (116), presupuestos (118) — se
...
E2 selección de tool  tool equivocada o descripción de tool ambigua (113)
E3 argumentos         schema correcto, valores incorrectos
E4 interpretación     la observación se leyó mal (o se ignoró)
E5 planificación      descomposición u orden defectuosos (112)
...
intervención elegida: prohibir editar tests vía permisos (116) — convierte
...
éxito por categoría, costo por éxito (118) y violaciones (116-117), calibración
