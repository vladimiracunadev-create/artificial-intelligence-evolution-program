...
# Teoría — Prompt, recurso, tool, skill, workflow y agente
...
`Prompt, recurso, tool, skill, workflow y agente` se estudia como un sistema con:
...
Conceptos guía: **prompt, resource, tool, skill, agent**.
