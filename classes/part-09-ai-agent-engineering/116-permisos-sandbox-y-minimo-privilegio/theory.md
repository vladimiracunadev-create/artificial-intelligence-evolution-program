...
# Teoría — Permisos, sandbox y mínimo privilegio
...
`Permisos, sandbox y mínimo privilegio` se estudia como un sistema con:
...
Conceptos guía: **permissions, sandbox, least privilege, secrets**.
