...
# Teoría — Anatomía: instrucciones, herramientas, estado y salida
...
`Anatomía: instrucciones, herramientas, estado y salida` se estudia como un sistema con:
...
Conceptos guía: **instructions, tools, state, output**.
