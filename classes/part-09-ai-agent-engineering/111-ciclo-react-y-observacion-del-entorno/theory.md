...
# Teoría — Ciclo ReAct y observación del entorno
...
`Ciclo ReAct y observación del entorno` se estudia como un sistema con:
...
Conceptos guía: **ReAct, thought-action, observation, loop**.
