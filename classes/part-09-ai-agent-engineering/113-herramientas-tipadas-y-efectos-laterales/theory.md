...
# Teoría — Herramientas tipadas y efectos laterales
...
`Herramientas tipadas y efectos laterales` se estudia como un sistema con:
...
Conceptos guía: **tool schema, side effects, idempotencia, errores**.
