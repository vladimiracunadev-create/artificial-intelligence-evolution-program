...
# Teoría — Planificación y descomposición de tareas
...
`Planificación y descomposición de tareas` se estudia como un sistema con:
...
Conceptos guía: **planning, decomposition, milestones, stop**.
