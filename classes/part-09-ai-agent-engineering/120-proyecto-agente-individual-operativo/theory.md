...
# Teoría — Proyecto: agente individual operativo
...
`Proyecto: agente individual operativo` se estudia como un sistema con:
...
Conceptos guía: **agent, tools, memory, approval, evals**.
