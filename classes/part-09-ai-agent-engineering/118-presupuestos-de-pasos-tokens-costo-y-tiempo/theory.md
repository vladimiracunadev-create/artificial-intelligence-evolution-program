...
# Teoría — Presupuestos de pasos, tokens, costo y tiempo
...
`Presupuestos de pasos, tokens, costo y tiempo` se estudia como un sistema con:
...
Conceptos guía: **budget, tokens, cost, timeout**.
