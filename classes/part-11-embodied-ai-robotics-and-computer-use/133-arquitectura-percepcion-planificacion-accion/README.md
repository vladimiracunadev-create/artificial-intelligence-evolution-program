...
# 133 — Arquitectura percepción-planificación-acción

> [← Clase anterior](../../../classes/part-10-multi-agent-systems-and-interoperability/132-proyecto-sistema-multiagente-durable/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-11-embodied-ai-robotics-and-computer-use/134-sensores-actuadores-y-fusion/README.md)
...
respuesta condiciona todo lo que sigue: fusión sensorial (134), SLAM (135),
planificación (136) y control (137). El mismo dilema arquitectónico reaparece en
...
- **Planificación**: decide qué hacer dado el estado estimado y un objetivo.
  ...
  espacio de estados (A*, clase 136).
