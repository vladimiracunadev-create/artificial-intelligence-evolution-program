...
# Teoría — Arquitectura percepción-planificación-acción
...
`Arquitectura percepción-planificación-acción` se estudia como un sistema con:
...
Conceptos guía: **perception, planning, action, feedback**.
