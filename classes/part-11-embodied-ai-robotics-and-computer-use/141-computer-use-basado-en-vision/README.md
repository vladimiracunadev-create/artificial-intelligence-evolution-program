...
> [← Clase anterior](../../../classes/part-11-embodied-ai-robotics-and-computer-use/140-robots-colaborativos-y-seguridad-fisica/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-11-embodied-ai-robotics-and-computer-use/142-agentes-de-navegador/README.md)
...
clase 133 aplicado al escritorio. Es la vía más general de automatización
(funciona sobre cualquier interfaz hecha para humanos, sin API), la base de
los agentes de navegador (142) y de la RPA agéntica (143), y el escenario
...
horizonte de la clase 138 aplicada al escritorio.
...
su propia UI). Los sistemas serios combinan ambos cuando pueden; la clase 142
...
la deriva de odometría de la clase 135.
...
responsable (que la clase 144 convierte en proyecto): lista de acciones que
...
[142 — Agentes de navegador](../../part-11-embodied-ai-robotics-and-computer-use/142-agentes-de-navegador/README.md)
