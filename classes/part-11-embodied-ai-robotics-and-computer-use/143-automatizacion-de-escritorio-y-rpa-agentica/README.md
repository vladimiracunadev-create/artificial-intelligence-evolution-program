...
# 143 — Automatización de escritorio y RPA agéntica

> [← Clase anterior](../../../classes/part-11-embodied-ai-robotics-and-computer-use/142-agentes-de-navegador/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-11-embodied-ai-robotics-and-computer-use/144-proyecto-agente-que-actua-con-limites/README.md)
...
aporta de verdad un agente (clases 141-142) cuando se inserta en un proceso
de negocio, y qué NO conviene delegarle. Esta clase es el puente entre el
computer use como capacidad y el proyecto final (144), donde la automatización
...
screenshot-acción-resultado de la clase 141). La auditoría no es burocracia:
