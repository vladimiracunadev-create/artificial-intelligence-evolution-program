...
# Teoría — Automatización de escritorio y RPA agéntica
...
`Automatización de escritorio y RPA agéntica` se estudia como un sistema con:
...
Conceptos guía: **desktop, RPA, Playwright, evidence**.
