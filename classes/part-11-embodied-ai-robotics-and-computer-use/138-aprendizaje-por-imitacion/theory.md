...
# Teoría — Aprendizaje por imitación
...
`Aprendizaje por imitación` se estudia como un sistema con:
...
Conceptos guía: **imitation, demonstrations, behavior cloning, DAgger**.
