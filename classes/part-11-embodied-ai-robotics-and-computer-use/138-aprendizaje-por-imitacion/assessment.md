...
# Evaluación — 138 Aprendizaje por imitación

## ❓ Preguntas

1. Define aprendizaje por imitación sin usar una marca o framework como definición.
2. Explica la relación entre imitation, demonstrations, behavior cloning, DAgger.
