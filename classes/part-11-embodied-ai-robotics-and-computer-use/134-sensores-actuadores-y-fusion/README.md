...
> [← Clase anterior](../../../classes/part-11-embodied-ai-robotics-and-computer-use/133-arquitectura-percepcion-planificacion-accion/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-11-embodied-ai-robotics-and-computer-use/135-localizacion-mapeo-y-slam/README.md)
...
filtro de Kalman como pieza central — que la clase 133 dio por supuesto al
hablar de "percepción". Es el prerequisito directo de SLAM (135), donde la
fusión se extiende de un estado escalar a la pose y el mapa completos, y del
control (137), que necesita estimaciones limpias para cerrar el lazo.
...
exactamente 1 m — y de que el feedback de la clase 133 sea imprescindible.
...
| EKF | No lineal suave | Linealización local válida | O(n³) | SLAM (clase 135), IMU 3D |
...
- [Welch, G. & Bishop, G. An Introduction to the Kalman Filter (informe técnico UNC)](https://www.cs.unc.edu/~welch/media/pdf/kalman_intro.pdf)
...
[133 — Arquitectura percepción-planificación-acción](../../part-11-embodied-ai-robotics-and-computer-use/133-arquitectura-percepcion-planificacion-accion/README.md)
