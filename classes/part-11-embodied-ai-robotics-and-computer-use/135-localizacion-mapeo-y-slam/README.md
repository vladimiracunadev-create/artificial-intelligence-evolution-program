...
> [← Clase anterior](../../../classes/part-11-embodied-ai-robotics-and-computer-use/134-sensores-actuadores-y-fusion/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-11-embodied-ai-robotics-and-computer-use/136-planificacion-de-movimiento-y-navegacion/README.md)
...
Con sensores calibrados y fusión (clase 134), el robot puede estimar *cuánto se
...
planificación de movimiento (clase 136).
...
EKF-SLAM extiende el filtro de Kalman (clase 134) a un estado aumentado que
...
flowchart TD
    ...
    A --> S
    L --> S
    S -->|mapa y pose| P[Planificación<br/>clase 136]
```
...
[134 — Sensores, actuadores y fusión](../../part-11-embodied-ai-robotics-and-computer-use/134-sensores-actuadores-y-fusion/README.md)

## ➡️ Siguiente clase

[136 — Planificación de movimiento y navegación](../../part-11-embodied-ai-robotics-and-computer-use/136-planificacion-de-movimiento-y-navegacion/README.md)
