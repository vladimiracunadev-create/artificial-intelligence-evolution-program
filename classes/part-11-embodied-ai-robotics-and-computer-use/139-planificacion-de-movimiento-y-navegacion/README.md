...
> [← Clase anterior](../../../classes/part-11-embodied-ai-robotics-and-computer-use/138-localizacion-mapeo-y-slam/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-11-embodied-ai-robotics-and-computer-use/140-control-clasico-y-control-aprendido/README.md)
...
Con una pose y un mapa (clase 138), la pregunta siguiente es *cómo llegar de A
...
control de bajo nivel (clase 140), y sus ideas reaparecen en los agentes
...
jerarquía deliberativo/reactivo de la clase 136.
...
flowchart TD
    ...
    LP -->|v, ω| CTRL[Control de motores<br/>clase 140]
...
|---|---|---|---|
| Russell, Stuart J. y Norvig, Peter — *Artificial Intelligence: A Modern Approach* | 4.ª · 2020 | [ISBN 9780134610993](https://openlibrary.org/isbn/9780134610993) · [web de la obra](https://aima.cs.berkeley.edu/) | citada en las referencias de esta clase · cap. 3 |
