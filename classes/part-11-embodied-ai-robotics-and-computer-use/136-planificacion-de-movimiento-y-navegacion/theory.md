...
# Teoría — Planificación de movimiento y navegación
...
`Planificación de movimiento y navegación` se estudia como un sistema con:
...
Conceptos guía: **path planning, navigation, obstacles, A***.
