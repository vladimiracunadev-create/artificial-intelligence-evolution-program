...
> [← Clase anterior](../../../classes/part-11-embodied-ai-robotics-and-computer-use/143-automatizacion-de-escritorio-y-rpa-agentica/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-12-ai-engineering-mlops-llmops-and-agentops/145-ciclo-de-vida-de-datos-modelos-y-agentes/README.md)
...
percepción–planificación–acción (133), la incertidumbre sensorial (134-135), la
planificación de movimiento (136), el control (137-138), la transferencia
sim-to-real (139), la seguridad física (140) y el uso de computadores por visión
...
[143 — Automatización de escritorio y RPA agéntica](../../part-11-embodied-ai-robotics-and-computer-use/143-automatizacion-de-escritorio-y-rpa-agentica/README.md)

## ➡️ Siguiente clase

[145 — Ciclo de vida de datos, modelos y agentes](../../part-12-ai-engineering-mlops-llmops-and-agentops/145-ciclo-de-vida-de-datos-modelos-y-agentes/README.md)
