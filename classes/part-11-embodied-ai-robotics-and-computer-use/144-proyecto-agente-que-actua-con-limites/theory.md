...
# Teoría — Proyecto: agente que actúa con límites
...
`Proyecto: agente que actúa con límites` se estudia como un sistema con:
...
Conceptos guía: **embodied, computer use, approval, evidence**.
