...
# Teoría — Control clásico y control aprendido
...
`Control clásico y control aprendido` se estudia como un sistema con:
...
Conceptos guía: **PID, control, policy, stability**.
