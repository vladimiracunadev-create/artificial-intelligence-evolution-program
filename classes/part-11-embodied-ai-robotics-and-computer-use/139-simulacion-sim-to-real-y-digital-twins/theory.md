...
# Teoría — Simulación, sim-to-real y digital twins
...
`Simulación, sim-to-real y digital twins` se estudia como un sistema con:
...
Conceptos guía: **simulation, sim-to-real, digital twin, domain randomization**.
