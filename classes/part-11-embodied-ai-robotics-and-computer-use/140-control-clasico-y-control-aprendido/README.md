...
|---|---:|---|---|
| [P102 · Algoritmos de optimización proximal de políticas](../../../papers/foundational/P102_ppo/README.md) | 2017 | Consigue la estabilidad de TRPO con una función objetivo que se implementa en unas líneas y se optimiza con descenso de gradiente corriente. | [notebook](../../../notebooks/papers/P102_ppo.ipynb) |
...
|---|---|---|---|
| Sutton, Richard S. y Barto, Andrew G. — *Reinforcement Learning: An Introduction* | 2.ª · 2018 | [ISBN 9780262039246](https://openlibrary.org/isbn/9780262039246) · [web de la obra](http://incompleteideas.net/book/the-book-2nd.html) | citada en las referencias de esta clase · caps. 13 y 16 |
