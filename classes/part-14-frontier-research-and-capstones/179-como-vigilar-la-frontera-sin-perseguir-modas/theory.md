...
# Teoría — Cómo vigilar la frontera sin perseguir modas
...
`Cómo vigilar la frontera sin perseguir modas` se estudia como un sistema con:
...
Conceptos guía: **frontier, evidence, maturity, hype**.
