...
# Teoría — World models y simulación interna
...
`World models y simulación interna` se estudia como un sistema con:
...
Conceptos guía: **world models, simulation, planning, latent**.
