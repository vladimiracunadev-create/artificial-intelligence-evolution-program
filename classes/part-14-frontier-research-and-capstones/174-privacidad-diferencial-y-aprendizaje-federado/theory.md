...
# Teoría — Privacidad diferencial y aprendizaje federado
...
`Privacidad diferencial y aprendizaje federado` se estudia como un sistema con:
...
Conceptos guía: **differential privacy, federated, secure aggregation, leakage**.
