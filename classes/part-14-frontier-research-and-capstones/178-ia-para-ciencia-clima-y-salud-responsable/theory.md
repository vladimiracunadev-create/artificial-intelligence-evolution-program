...
# Teoría — IA para ciencia, clima y salud responsable
...
`IA para ciencia, clima y salud responsable` se estudia como un sistema con:
...
Conceptos guía: **science, climate, health, validation**.
