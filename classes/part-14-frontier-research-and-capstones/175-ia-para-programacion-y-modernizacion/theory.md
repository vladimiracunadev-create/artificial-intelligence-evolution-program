...
# Teoría — IA para programación y modernización
...
`IA para programación y modernización` se estudia como un sistema con:
...
Conceptos guía: **coding agents, tests, migration, legacy**.
