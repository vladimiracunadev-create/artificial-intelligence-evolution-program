...
# Teoría — Capstone final: sistema de IA evolutivo
...
`Capstone final: sistema de IA evolutivo` se estudia como un sistema con:
...
Conceptos guía: **portfolio, system, agents, safety, operations**.
