...
# Teoría — Golden datasets, regresión y LLM-as-judge
...
`Golden datasets, regresión y LLM-as-judge` se estudia como un sistema con:
...
Conceptos guía: **golden set, regression, judge, agreement**.
