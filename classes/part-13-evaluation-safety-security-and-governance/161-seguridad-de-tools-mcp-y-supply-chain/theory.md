...
# Teoría — Seguridad de tools, MCP y supply chain
...
`Seguridad de tools, MCP y supply chain` se estudia como un sistema con:
...
Conceptos guía: **tools, MCP, supply chain, permissions**.
