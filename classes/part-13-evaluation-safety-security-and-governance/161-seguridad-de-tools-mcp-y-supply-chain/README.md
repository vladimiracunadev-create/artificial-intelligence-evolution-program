...
> [← Clase anterior](../../../classes/part-13-evaluation-safety-security-and-governance/160-prompt-injection-e-instrucciones-no-confiables/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-13-evaluation-safety-security-and-governance/162-privacidad-secretos-y-minimizacion-de-datos/README.md)
...
clase 160) lo convence de invocarlo con argumentos elegidos por el atacante. El agente es el
...
[160 — Prompt injection e instrucciones no confiables](../../part-13-evaluation-safety-security-and-governance/160-prompt-injection-e-instrucciones-no-confiables/README.md)

## ➡️ Siguiente clase

[162 — Privacidad, secretos y minimización de datos](../../part-13-evaluation-safety-security-and-governance/162-privacidad-secretos-y-minimizacion-de-datos/README.md)
