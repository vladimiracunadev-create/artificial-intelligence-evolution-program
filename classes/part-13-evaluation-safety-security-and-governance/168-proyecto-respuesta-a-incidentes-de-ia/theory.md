...
# Teoría — Proyecto: respuesta a incidentes de IA
...
`Proyecto: respuesta a incidentes de IA` se estudia como un sistema con:
...
Conceptos guía: **incident, containment, evidence, recovery**.
