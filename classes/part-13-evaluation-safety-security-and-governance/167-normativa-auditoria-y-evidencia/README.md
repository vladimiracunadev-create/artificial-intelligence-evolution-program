...
# 167 — Normativa, auditoría y evidencia

> [← Clase anterior](../../../classes/part-13-evaluation-safety-security-and-governance/166-gobernanza-roles-y-gestion-de-riesgo/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-13-evaluation-safety-security-and-governance/168-proyecto-respuesta-a-incidentes-de-ia/README.md)
...
La gobernanza interna (clase 166) se encuentra con la obligación externa: leyes que imponen qué
...
- Análisis cuantitativo  : desempeño DESGLOSADO por subgrupo (conecta con clase 163)
...
Modelo y dato tienen fichas distintas porque los sesgos y límites del dato (clase 162-163) preceden
...
| Registro de riesgos | el proceso de gestión | ¿qué riesgos y quién los acepta? | NIST/clase 166 |
| Logs de trazabilidad | la operación | ¿qué pasó y cuándo? | AI Act / clase 168 |
...
5. **"El EU AI Act certifica que el sistema es seguro"**. Impone obligaciones y evidencia; el
   cumplimiento legal no equivale a ausencia de riesgo técnico (clase 166).
...
(clase 168) cierra el ciclo cuando la evidencia revela un fallo en producción. Esta clase solo
...
[166 — Gobernanza, roles y gestión de riesgo](../../part-13-evaluation-safety-security-and-governance/166-gobernanza-roles-y-gestion-de-riesgo/README.md)

## ➡️ Siguiente clase

[168 — Proyecto: respuesta a incidentes de IA](../../part-13-evaluation-safety-security-and-governance/168-proyecto-respuesta-a-incidentes-de-ia/README.md)
