...
# Teoría — Prompt injection e instrucciones no confiables
...
`Prompt injection e instrucciones no confiables` se estudia como un sistema con:
...
Conceptos guía: **prompt injection, untrusted input, hierarchy, isolation**.
