...
> [← Clase anterior](../../../classes/part-13-evaluation-safety-security-and-governance/159-red-teaming-y-abuso/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-13-evaluation-safety-security-and-governance/161-seguridad-de-tools-mcp-y-supply-chain/README.md)
...
3. **"Si el modelo no obedeció esta vez, está seguro"**. La resistencia es estadística; un cambio
   de fraseo o de modelo reabre el fallo. Se prueba con regresión adversarial (clases 158-159).
...
y la clase 161 (seguridad de tools/MCP) extienden estas defensas al plano de la cadena de
...
[159 — Red teaming y abuso](../../part-13-evaluation-safety-security-and-governance/159-red-teaming-y-abuso/README.md)

## ➡️ Siguiente clase

[161 — Seguridad de tools, MCP y supply chain](../../part-13-evaluation-safety-security-and-governance/161-seguridad-de-tools-mcp-y-supply-chain/README.md)
