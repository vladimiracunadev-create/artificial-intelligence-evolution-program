...
> [← Clase anterior](../../../classes/part-13-evaluation-safety-security-and-governance/164-explicabilidad-incertidumbre-y-calibracion/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-13-evaluation-safety-security-and-governance/166-gobernanza-roles-y-gestion-de-riesgo/README.md)
...
evaluación uniendo lo aprendido sobre calibración (clase 164): abstenerse bien exige saber cuándo
el modelo no sabe.
...
está bien calibrada (clase 164)— baja el riesgo. Un sistema útil abstiene en su zona de baja
...
3. **"Abstener es fácil: pon un umbral"**. Solo funciona si la confianza está calibrada (clase 164);
...
[164 — Explicabilidad, incertidumbre y calibración](../../part-13-evaluation-safety-security-and-governance/164-explicabilidad-incertidumbre-y-calibracion/README.md)
