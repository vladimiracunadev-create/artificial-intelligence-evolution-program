...
# Teoría — Alucinación, grounding y abstención
...
`Alucinación, grounding y abstención` se estudia como un sistema con:
...
Conceptos guía: **hallucination, grounding, abstention, evidence**.
