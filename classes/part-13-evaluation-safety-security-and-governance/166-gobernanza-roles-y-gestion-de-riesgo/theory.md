...
# Teoría — Gobernanza, roles y gestión de riesgo
...
`Gobernanza, roles y gestión de riesgo` se estudia como un sistema con:
...
Conceptos guía: **governance, roles, risk, controls**.
