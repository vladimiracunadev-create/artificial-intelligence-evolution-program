...
> [← Clase anterior](../../../classes/part-07-generative-ai-across-media/090-generacion-musical-y-de-audio/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-07-generative-ai-across-media/092-generacion-y-edicion-de-video/README.md)
...
la humana. Hereda directamente la generación de audio de la clase anterior (090) y añade
...
consentimiento, y prepara la discusión de procedencia y autenticidad de la clase 095.
...
3. **Procedencia**: sin marcas técnicas (watermarking de audio, credenciales C2PA), un
   ...
   verificación de origen, no del contenido (clase 095).
...
[090 — Generación musical y de audio](../../part-07-generative-ai-across-media/090-generacion-musical-y-de-audio/README.md)

## ➡️ Siguiente clase

[092 — Generación y edición de video](../../part-07-generative-ai-across-media/092-generacion-y-edicion-de-video/README.md)
