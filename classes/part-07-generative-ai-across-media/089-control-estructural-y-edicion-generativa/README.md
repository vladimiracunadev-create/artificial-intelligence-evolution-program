...
> [← Clase anterior](../../../classes/part-07-generative-ai-across-media/088-texto-a-imagen-y-condicionamiento/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-07-generative-ai-across-media/090-generacion-musical-y-de-audio/README.md)
...
El texto (clase 088) especifica *qué* generar, pero no *dónde ni cómo*: un prompt no
...
|---|---|---|---|---|
| Prompt (clase 088) | contenido semántico global | no | 0 | sin control espacial preciso |
