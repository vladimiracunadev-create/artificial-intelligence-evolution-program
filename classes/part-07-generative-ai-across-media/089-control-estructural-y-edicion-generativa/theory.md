...
# Teoría — Control estructural y edición generativa
...
`Control estructural y edición generativa` se estudia como un sistema con:
...
Conceptos guía: **inpainting, control, pose, depth**.
