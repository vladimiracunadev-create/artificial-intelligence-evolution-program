...
> [← Clase anterior](../../../classes/part-07-generative-ai-across-media/089-control-estructural-y-edicion-generativa/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-07-generative-ai-across-media/091-sintesis-de-voz-y-derechos-de-identidad/README.md)
...
espectrogramas. La clase 091 (síntesis de voz) reutiliza estas mismas
representaciones.
...
**Difusión sobre espectrogramas**: aplicar el pipeline de la clase 087-088 tratando
