...
# Teoría — Proyecto: pipeline creativo trazable
...
`Proyecto: pipeline creativo trazable` se estudia como un sistema con:
...
Conceptos guía: **multimedia, provenance, evaluación, publicación**.
