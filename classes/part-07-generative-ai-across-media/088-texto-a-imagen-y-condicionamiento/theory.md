...
# Teoría — Texto a imagen y condicionamiento
...
`Texto a imagen y condicionamiento` se estudia como un sistema con:
...
Conceptos guía: **text-to-image, conditioning, guidance, prompt**.
