...
> [← Clase anterior](../../../classes/part-07-generative-ai-across-media/087-modelos-de-difusion/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-07-generative-ai-across-media/089-control-estructural-y-edicion-generativa/README.md)
...
Los modelos de difusión de la clase 087 generan imágenes, pero sin control: muestrean
...
Diffusion). Estas mismas técnicas de condicionamiento habilitan la clase 089 (control
...
| GAN condicional (clase 086) | píxeles | vector/embedding en G y D | 1 pasada (rapidísimo) | entrenamiento inestable, menor diversidad |
...
[087 — Modelos de difusión](../../part-07-generative-ai-across-media/087-modelos-de-difusion/README.md)

## ➡️ Siguiente clase

[089 — Control estructural y edición generativa](../../part-07-generative-ai-across-media/089-control-estructural-y-edicion-generativa/README.md)
