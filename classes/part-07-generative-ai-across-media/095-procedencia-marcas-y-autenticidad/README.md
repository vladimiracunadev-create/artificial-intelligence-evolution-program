...
> [← Clase anterior](../../../classes/part-07-generative-ai-across-media/094-datos-sinteticos-utilidad-y-contaminacion/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-07-generative-ai-across-media/096-proyecto-pipeline-creativo-trazable/README.md)
...
Cuando los generadores de las clases 085–093 producen contenido indistinguible del
...
pipeline trazable del proyecto integrador (clase 096) y la mitigación de la
contaminación de corpus (clase 094).
...
[094 — Datos sintéticos: utilidad y contaminación](../../part-07-generative-ai-across-media/094-datos-sinteticos-utilidad-y-contaminacion/README.md)

## ➡️ Siguiente clase

[096 — Proyecto: pipeline creativo trazable](../../part-07-generative-ai-across-media/096-proyecto-pipeline-creativo-trazable/README.md)
