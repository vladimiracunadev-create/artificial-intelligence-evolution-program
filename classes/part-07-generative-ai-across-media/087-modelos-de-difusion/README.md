...
> [← Clase anterior](../../../classes/part-07-generative-ai-across-media/086-gan-y-entrenamiento-adversarial/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-07-generative-ai-across-media/088-texto-a-imagen-y-condicionamiento/README.md)
...
un solo objetivo. Combinan lo mejor de las dos clases anteriores: como el VAE (085)
optimizan una cota variacional, y como el GAN (086) producen muestras nítidas —
...
por texto (088) se monta sobre exactamente este proceso.
...
| Propiedad | DDPM | DDIM | GAN (086) | VAE (085) |
|---|---|---|---|---|
...
cientos de millones de parámetros condicionada en t (y en texto, clase 088),
...
de procedencia que cierra esta parte (clase 095).
...
[088 — Texto a imagen y condicionamiento](../../part-07-generative-ai-across-media/088-texto-a-imagen-y-condicionamiento/README.md)
