...
# Teoría — Espacios latentes y autoencoders variacionales
...
`Espacios latentes y autoencoders variacionales` se estudia como un sistema con:
...
Conceptos guía: **VAE, latente, reconstrucción, muestreo**.
