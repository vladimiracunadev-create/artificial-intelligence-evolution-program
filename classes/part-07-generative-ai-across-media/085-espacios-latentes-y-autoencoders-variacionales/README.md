...
aprendizaje de representaciones, y habilita lo que sigue en esta parte: los GAN (086)
compiten con él en calidad de muestra, y los modelos de difusión (087) generalizan su
...
| Propiedad | VAE | Autoencoder clásico | GAN (clase 086) | Difusión (clase 087) |
|---|---|---|---|---|
