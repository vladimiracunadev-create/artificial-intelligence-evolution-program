...
> [← Clase anterior](../../../classes/part-07-generative-ai-across-media/085-espacios-latentes-y-autoencoders-variacionales/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-07-generative-ai-across-media/087-modelos-de-difusion/README.md)
...
en vez de maximizar una verosimilitud (como el VAE de la clase 085), dos redes
...
(clase 087) los desplazaron precisamente atacando su punto débil: la inestabilidad.
...
| Propiedad | GAN (original) | WGAN | VAE (clase 085) | Difusión (clase 087) |
|---|---|---|---|---|
...
la procedencia del contenido (clase 095) en requisito operativo, no en opción.
