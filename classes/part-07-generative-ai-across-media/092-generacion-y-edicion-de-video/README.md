...
(clases 087-088) y añade la dimensión que las imágenes no tienen: el **tiempo**. Un
...
la generación 3D (clase 093), donde la consistencia deja de ser temporal y pasa a ser
geométrica.
