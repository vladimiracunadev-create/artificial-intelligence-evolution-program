...
# Teoría — Generación y edición de video
...
`Generación y edición de video` se estudia como un sistema con:
...
Conceptos guía: **video, temporalidad, consistencia, edición**.
