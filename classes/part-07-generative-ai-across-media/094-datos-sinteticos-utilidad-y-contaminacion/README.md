...
# 094 — Datos sintéticos: utilidad y contaminación

> [← Clase anterior](../../../classes/part-07-generative-ai-across-media/093-generacion-3d-y-mundos-sinteticos/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-07-generative-ai-across-media/095-procedencia-marcas-y-autenticidad/README.md)
...
Las clases 085–093 mostraron cómo generar texto, imagen, audio, video y 3D. Esta clase
...
(clase 095) en un problema de ingeniería, no solo de ética.
...
4. **"Mezclar un poco de dato real lo arregla todo."** Conservar una fracción de datos
   ...
   pero exige saber *cuáles* datos son reales: sin procedencia (clase 095) no puedes
...
- C2PA (procedencia como mitigación de contaminación, ver clase 095): [especificación 2.2](https://c2pa.org/specifications/specifications/2.2/index.html)
...
[095 — Procedencia, marcas y autenticidad](../../part-07-generative-ai-across-media/095-procedencia-marcas-y-autenticidad/README.md)
