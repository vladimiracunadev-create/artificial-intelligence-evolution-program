...
# Teoría — Datos sintéticos: utilidad y contaminación
...
`Datos sintéticos: utilidad y contaminación` se estudia como un sistema con:
...
Conceptos guía: **synthetic data, leakage, collapse, calidad**.
