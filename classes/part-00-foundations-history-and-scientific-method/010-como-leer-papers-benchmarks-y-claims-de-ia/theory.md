...
# Teoría — Cómo leer papers, benchmarks y claims de IA
...
`Cómo leer papers, benchmarks y claims de IA` se estudia como un sistema con:
...
Conceptos guía: **papers, benchmarks, claims, replicación**.
