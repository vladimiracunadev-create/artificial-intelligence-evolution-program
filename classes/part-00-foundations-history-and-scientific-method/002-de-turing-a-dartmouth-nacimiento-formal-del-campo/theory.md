...
# Teoría — De Turing a Dartmouth: nacimiento formal del campo
...
`De Turing a Dartmouth: nacimiento formal del campo` se estudia como un sistema con:
...
Conceptos guía: **Turing, Dartmouth, historia, hitos**.
