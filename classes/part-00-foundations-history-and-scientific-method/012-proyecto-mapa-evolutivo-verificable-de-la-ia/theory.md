...
# Teoría — Proyecto: mapa evolutivo verificable de la IA
...
`Proyecto: mapa evolutivo verificable de la IA` se estudia como un sistema con:
...
Conceptos guía: **timeline, evidencia, fuentes, taxonomía**.
