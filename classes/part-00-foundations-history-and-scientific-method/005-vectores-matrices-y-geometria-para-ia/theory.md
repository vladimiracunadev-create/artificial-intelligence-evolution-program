...
# Teoría — Vectores, matrices y geometría para IA
...
`Vectores, matrices y geometría para IA` se estudia como un sistema con:
...
Conceptos guía: **vectores, matrices, producto punto, distancia**.
