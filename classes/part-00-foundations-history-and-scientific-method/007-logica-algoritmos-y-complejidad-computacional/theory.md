...
# Teoría — Lógica, algoritmos y complejidad computacional
...
`Lógica, algoritmos y complejidad computacional` se estudia como un sistema con:
...
Conceptos guía: **lógica, algoritmos, complejidad, decidibilidad**.
