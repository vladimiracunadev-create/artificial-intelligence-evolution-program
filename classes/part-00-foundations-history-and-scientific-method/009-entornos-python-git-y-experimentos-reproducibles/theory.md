...
# Teoría — Entornos Python, Git y experimentos reproducibles
...
`Entornos Python, Git y experimentos reproducibles` se estudia como un sistema con:
...
Conceptos guía: **Python, Git, semillas, entornos**.
