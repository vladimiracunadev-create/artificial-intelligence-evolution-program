...
> [← Clase anterior](../../../classes/part-10-multi-agent-systems-and-interoperability/124-supervisor-workers/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-10-multi-agent-systems-and-interoperability/126-critica-revision-y-debate-controlado/README.md)
...
- **Independencia del map**: worker_i no necesita ver a worker_j. Si la necesita, el
  problema no es map-reduce (usa blackboard, clase 127, o secuencia).
...
[124 — Supervisor-workers](../../part-10-multi-agent-systems-and-interoperability/124-supervisor-workers/README.md)
