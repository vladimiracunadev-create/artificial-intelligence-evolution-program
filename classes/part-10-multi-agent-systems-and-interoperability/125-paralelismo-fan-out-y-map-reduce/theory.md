...
# Teoría — Paralelismo, fan-out y map-reduce
...
`Paralelismo, fan-out y map-reduce` se estudia como un sistema con:
...
Conceptos guía: **parallel, fan-out, map-reduce, merge**.
