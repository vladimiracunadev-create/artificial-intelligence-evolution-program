...
# Teoría — A2A, descubrimiento e interoperabilidad
...
`A2A, descubrimiento e interoperabilidad` se estudia como un sistema con:
...
Conceptos guía: **A2A, discovery, agent card, tasks**.
