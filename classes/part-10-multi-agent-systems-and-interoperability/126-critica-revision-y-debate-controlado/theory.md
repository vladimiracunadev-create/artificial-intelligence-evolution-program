...
# Teoría — Crítica, revisión y debate controlado
...
`Crítica, revisión y debate controlado` se estudia como un sistema con:
...
Conceptos guía: **critic, reviewer, debate, convergence**.
