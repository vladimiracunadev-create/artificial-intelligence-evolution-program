...
> [← Clase anterior](../../../classes/part-10-multi-agent-systems-and-interoperability/122-router-y-especialistas/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-10-multi-agent-systems-and-interoperability/124-supervisor-workers/README.md)
...
El *handoff* resuelve la limitación del router (122): allí la decisión de a quién va la
...
soporte, y prepara los protocolos entre organizaciones (A2A, clase 131), donde el
