...
# Teoría — Handoffs y transferencia de contexto
...
`Handoffs y transferencia de contexto` se estudia como un sistema con:
...
Conceptos guía: **handoff, context, ownership, escalation**.
