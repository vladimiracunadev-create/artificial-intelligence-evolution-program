...
> [← Clase anterior](../../../classes/part-10-multi-agent-systems-and-interoperability/133-agent-skills-como-capacidades-portables/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-10-multi-agent-systems-and-interoperability/135-proyecto-sistema-multiagente-durable/README.md)
...
Con MCP (132) un agente habla con sus herramientas; falta el otro eje: agentes de
...
4. **Confiar en la Agent Card sin verificar.** La card es una *declaración*
   ...
   conformance tests y SLA (clase 131), no leyendo el JSON.
...
**Normas y documentación oficial que aplica esta clase:** [A2A Protocol](https://a2a-protocol.org/latest/) · [Model Context Protocol](https://modelcontextprotocol.io)
<!-- bibliografia:fin -->
