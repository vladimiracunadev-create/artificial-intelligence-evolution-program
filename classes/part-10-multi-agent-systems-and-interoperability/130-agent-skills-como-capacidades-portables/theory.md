...
# Teoría — Agent Skills como capacidades portables
...
`Agent Skills como capacidades portables` se estudia como un sistema con:
...
Conceptos guía: **Agent Skills, instructions, scripts, portability**.
