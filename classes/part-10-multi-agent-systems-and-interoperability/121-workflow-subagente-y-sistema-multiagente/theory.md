...
# Teoría — Workflow, subagente y sistema multiagente
...
`Workflow, subagente y sistema multiagente` se estudia como un sistema con:
...
Conceptos guía: **workflow, subagent, multi-agent, delegation**.
