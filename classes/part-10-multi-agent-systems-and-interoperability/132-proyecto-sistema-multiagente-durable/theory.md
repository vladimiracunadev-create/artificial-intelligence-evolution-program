...
# Teoría — Proyecto: sistema multiagente durable
...
`Proyecto: sistema multiagente durable` se estudia como un sistema con:
...
Conceptos guía: **multi-agent, protocol, persistence, HITL**.
