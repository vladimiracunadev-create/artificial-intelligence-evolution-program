...
(121-127), contratos (128) y protocolos (129-131), bajo la restricción que separa una
...
- **Política de permisos por agente**: cada acción se evalúa contra los permisos del
  rol (contrato de la clase 128). En el laboratorio: `permissions: ["read"]` permite
...
- **Release gate**: la salida del sistema hacia el mundo pasa por una compuerta; en
  ...
  delante. El gate se registra como transición del workflow (clase 129: el estado
