...
# Evaluación — 128 Paralelismo, fan-out y map-reduce

## ❓ Preguntas

1. Define paralelismo, fan-out y map-reduce sin usar una marca o framework como definición.
2. Explica la relación entre parallel, fan-out, map-reduce, merge.
