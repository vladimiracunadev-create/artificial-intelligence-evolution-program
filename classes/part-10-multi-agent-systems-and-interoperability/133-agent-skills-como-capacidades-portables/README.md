...
> [← Clase anterior](../../../classes/part-10-multi-agent-systems-and-interoperability/132-mcp-tools-resources-y-prompts/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-10-multi-agent-systems-and-interoperability/134-a2a-descubrimiento-e-interoperabilidad/README.md)
...
MCP (132) estandarizó cómo un agente *accede* a herramientas y datos; los **Agent
...
pieza "know-how portable" del stack de interoperabilidad: los contratos (131) definen
