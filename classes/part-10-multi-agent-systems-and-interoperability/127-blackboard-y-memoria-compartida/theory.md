...
# Teoría — Blackboard y memoria compartida
...
`Blackboard y memoria compartida` se estudia como un sistema con:
...
Conceptos guía: **blackboard, shared memory, coordination, conflicts**.
