...
> [← Clase anterior](../../../classes/part-06-foundation-models-and-llm-engineering/081-serving-batching-y-caches/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-06-foundation-models-and-llm-engineering/083-seleccion-de-modelo-costo-latencia-y-privacidad/README.md)
...
y acelerando el decode (limitado por ancho de banda, clase 081). Junto con formatos
como GGUF y runtimes como llama.cpp, habilita la inferencia local — clave cuando la
privacidad manda (clase 083) — y ya apareció en el entrenamiento con QLoRA (077).
