...
# Teoría — Proyecto: servicio LLM con contratos y evals
...
`Proyecto: servicio LLM con contratos y evals` se estudia como un sistema con:
...
Conceptos guía: **LLM, API, evals, observabilidad**.
