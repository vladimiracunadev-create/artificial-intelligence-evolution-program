...
# Teoría — Instruction tuning y datos de instrucciones
...
`Instruction tuning y datos de instrucciones` se estudia como un sistema con:
...
Conceptos guía: **instruction tuning, SFT, datasets, calidad**.
