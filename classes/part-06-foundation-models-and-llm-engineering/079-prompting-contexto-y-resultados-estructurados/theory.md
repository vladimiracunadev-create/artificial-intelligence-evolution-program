...
# Teoría — Prompting, contexto y resultados estructurados
...
`Prompting, contexto y resultados estructurados` se estudia como un sistema con:
...
Conceptos guía: **prompting, contexto, JSON schema, constraints**.
