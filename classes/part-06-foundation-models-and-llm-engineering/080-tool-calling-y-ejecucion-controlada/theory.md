...
# Teoría — Tool calling y ejecución controlada
...
`Tool calling y ejecución controlada` se estudia como un sistema con:
...
Conceptos guía: **tool calling, funciones, permisos, validación**.
