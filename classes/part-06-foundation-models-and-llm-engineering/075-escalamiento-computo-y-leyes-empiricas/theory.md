...
# Teoría — Escalamiento, cómputo y leyes empíricas
...
`Escalamiento, cómputo y leyes empíricas` se estudia como un sistema con:
...
Conceptos guía: **scaling laws, compute, datos, parámetros**.
