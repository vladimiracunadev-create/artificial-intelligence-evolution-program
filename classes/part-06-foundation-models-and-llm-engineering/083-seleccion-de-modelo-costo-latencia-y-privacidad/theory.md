...
# Teoría — Selección de modelo, costo, latencia y privacidad
...
`Selección de modelo, costo, latencia y privacidad` se estudia como un sistema con:
...
Conceptos guía: **benchmark, costo, latencia, privacidad**.
