...
# Teoría — Tokenización moderna y vocabularios
...
`Tokenización moderna y vocabularios` se estudia como un sistema con:
...
Conceptos guía: **BPE, SentencePiece, tokens, vocabulario**.
