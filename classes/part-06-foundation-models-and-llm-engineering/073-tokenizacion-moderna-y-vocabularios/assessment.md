...
# Evaluación — 073 Tokenización moderna y vocabularios

## ❓ Preguntas

1. Define tokenización moderna y vocabularios sin usar una marca o framework como definición.
2. Explica la relación entre BPE, SentencePiece, tokens, vocabulario.
