...
# Teoría — Proyecto: modelo trazable de extremo a extremo
...
`Proyecto: modelo trazable de extremo a extremo` se estudia como un sistema con:
...
Conceptos guía: **dataset card, model card, registro, despliegue**.
