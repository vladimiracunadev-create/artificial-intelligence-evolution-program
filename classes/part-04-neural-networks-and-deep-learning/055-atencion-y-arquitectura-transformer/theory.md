...
# Teoría — Atención y arquitectura Transformer
...
`Atención y arquitectura Transformer` se estudia como un sistema con:
...
Conceptos guía: **self-attention, multi-head, positional, transformer**.
