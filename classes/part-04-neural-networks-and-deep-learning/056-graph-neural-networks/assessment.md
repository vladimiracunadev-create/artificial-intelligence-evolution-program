...
# Evaluación — 056 Graph Neural Networks

## ❓ Preguntas

1. Define graph neural networks sin usar una marca o framework como definición.
2. Explica la relación entre grafos, mensajes, GCN, GAT.
