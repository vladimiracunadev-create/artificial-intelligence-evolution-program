...
# Teoría — Optimizadores, regularización y schedulers
...
`Optimizadores, regularización y schedulers` se estudia como un sistema con:
...
Conceptos guía: **SGD, AdamW, dropout, scheduler**.
