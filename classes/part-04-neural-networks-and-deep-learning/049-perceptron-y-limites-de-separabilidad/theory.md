...
# Teoría — Perceptrón y límites de separabilidad
...
`Perceptrón y límites de separabilidad` se estudia como un sistema con:
...
Conceptos guía: **perceptrón, separabilidad, pesos, sesgo**.
