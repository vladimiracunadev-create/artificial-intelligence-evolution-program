...
# Teoría — Aprendizaje por refuerzo profundo
...
`Aprendizaje por refuerzo profundo` se estudia como un sistema con:
...
Conceptos guía: **DQN, policy gradient, PPO, recompensa**.
