...
# Teoría — Activaciones, inicialización y normalización
...
`Activaciones, inicialización y normalización` se estudia como un sistema con:
...
Conceptos guía: **ReLU, GELU, inicialización, normalización**.
