...
# Teoría — Planificación clásica con STRIPS y PDDL
...
`Planificación clásica con STRIPS y PDDL` se estudia como un sistema con:
...
Conceptos guía: **STRIPS, PDDL, precondiciones, efectos**.
