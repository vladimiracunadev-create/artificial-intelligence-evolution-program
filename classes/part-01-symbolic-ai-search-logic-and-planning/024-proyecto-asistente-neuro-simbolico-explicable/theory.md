...
# Teoría — Proyecto: asistente neuro-simbólico explicable
...
`Proyecto: asistente neuro-simbólico explicable` se estudia como un sistema con:
...
Conceptos guía: **símbolos, reglas, explicación, integración**.
