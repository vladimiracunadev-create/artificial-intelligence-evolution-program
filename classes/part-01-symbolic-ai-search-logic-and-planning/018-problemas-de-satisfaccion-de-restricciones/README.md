...
|---|---|---|---|
| Rossi, F., van Beek, P. y Walsh, T. — *Handbook of Constraint Programming* | 2006 | [ISBN 9780444527264](https://openlibrary.org/isbn/9780444527264) | citada en las referencias de esta clase |
| Russell, Stuart J. y Norvig, Peter — *Artificial Intelligence: A Modern Approach* | 4.ª · 2020 | [ISBN 9780134610993](https://openlibrary.org/isbn/9780134610993) · [web de la obra](https://aima.cs.berkeley.edu/) | citada en las referencias de esta clase · cap. 6 · obra de referencia de la parte 01 |
