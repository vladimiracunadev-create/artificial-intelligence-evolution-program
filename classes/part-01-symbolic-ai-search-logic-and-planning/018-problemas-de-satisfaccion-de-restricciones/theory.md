...
# Teoría — Problemas de satisfacción de restricciones
...
`Problemas de satisfacción de restricciones` se estudia como un sistema con:
...
Conceptos guía: **CSP, backtracking, consistencia, restricciones**.
