...
# Teoría — Juegos: minimax y poda alfa-beta
...
`Juegos: minimax y poda alfa-beta` se estudia como un sistema con:
...
Conceptos guía: **minimax, alfa-beta, adversarial, utilidad**.
