...
> [← Clase anterior](../../../classes/part-01-symbolic-ai-search-logic-and-planning/015-costo-uniforme-busqueda-voraz-y-a/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-01-symbolic-ai-search-logic-and-planning/017-juegos-minimax-y-poda-alfa-beta/README.md)
...
Comprender **diseño y validación de heurísticas** dentro de la evolución de la inteligencia
...
|---|---|---|---|
| Pearl, J. — *Heuristics: Intelligent Search Strategies for Computer Problem Solving* | 1984 | _sin localizador verificado_ | citada en las referencias de esta clase |
| Russell, Stuart J. y Norvig, Peter — *Artificial Intelligence: A Modern Approach* | 4.ª · 2020 | [ISBN 9780134610993](https://openlibrary.org/isbn/9780134610993) · [web de la obra](https://aima.cs.berkeley.edu/) | citada en las referencias de esta clase · obra de referencia de la parte 01 |
