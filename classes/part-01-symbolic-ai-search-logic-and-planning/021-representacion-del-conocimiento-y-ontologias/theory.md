...
# Teoría — Representación del conocimiento y ontologías
...
`Representación del conocimiento y ontologías` se estudia como un sistema con:
...
Conceptos guía: **ontologías, taxonomías, relaciones, inferencia**.
