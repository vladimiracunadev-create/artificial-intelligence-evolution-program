...
# Teoría — Lógica proposicional e inferencia
...
`Lógica proposicional e inferencia` se estudia como un sistema con:
...
Conceptos guía: **proposiciones, CNF, resolución, inferencia**.
