...
- Russell, S. y Norvig, P. (2021). *AIMA* (4.ª ed.), §3.3-3.4 "Search Algorithms / Uninformed Search Strategies". [https://aima.cs.berkeley.edu/](https://aima.cs.berkeley.edu/) — uso: desarrollo extendido del tema
...
- Korf, R. E. (1985). "Depth-first iterative-deepening: An optimal admissible tree search". *Artificial Intelligence*, 27(1). [https://doi.org/10.1016/0004-3702(85)90084-0](https://doi.org/10.1016/0004-3702%2885%2990084-0) — uso: fuente primaria del mecanismo estudiado
