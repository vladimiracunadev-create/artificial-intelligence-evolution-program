...
# Teoría — Proyecto: sistema híbrido para decisiones
...
`Proyecto: sistema híbrido para decisiones` se estudia como un sistema con:
...
Conceptos guía: **Bayes, reglas, optimización, trazabilidad**.
