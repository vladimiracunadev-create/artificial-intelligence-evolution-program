...
# Teoría — Lógica difusa y control aproximado
...
`Lógica difusa y control aproximado` se estudia como un sistema con:
...
Conceptos guía: **fuzzy, membresía, reglas, control**.
