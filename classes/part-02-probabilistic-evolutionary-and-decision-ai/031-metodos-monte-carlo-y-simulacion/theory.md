...
# Teoría — Métodos Monte Carlo y simulación
...
`Métodos Monte Carlo y simulación` se estudia como un sistema con:
...
Conceptos guía: **Monte Carlo, muestreo, estimación, varianza**.
