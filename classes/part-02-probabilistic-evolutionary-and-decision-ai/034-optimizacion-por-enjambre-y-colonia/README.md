...
|---|---|---|---|
| Dorigo, Marco y Stützle, Thomas — *Ant Colony Optimization (Bradford Books)* | 2004 | [ISBN 9780262042192](https://openlibrary.org/isbn/9780262042192) · [web de la obra](https://mitpress.mit.edu/9780262042192/ant-colony-optimization/) | citada en las referencias de esta clase |
| Bonabeau, E., Dorigo, M. y Theraulaz, G. — *Swarm Intelligence: From Natural to Artificial Systems* | 1999 | _sin localizador verificado_ | citada en las referencias de esta clase |
