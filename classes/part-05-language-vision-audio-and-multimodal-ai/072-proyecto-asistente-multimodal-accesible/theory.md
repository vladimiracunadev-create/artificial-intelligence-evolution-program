...
# Teoría — Proyecto: asistente multimodal accesible
...
`Proyecto: asistente multimodal accesible` se estudia como un sistema con:
...
Conceptos guía: **texto, imagen, audio, accesibilidad**.
