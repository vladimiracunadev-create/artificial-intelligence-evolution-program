...
# Teoría — Tokenización y representación del lenguaje
...
`Tokenización y representación del lenguaje` se estudia como un sistema con:
...
Conceptos guía: **tokens, vocabulario, subwords, embeddings**.
