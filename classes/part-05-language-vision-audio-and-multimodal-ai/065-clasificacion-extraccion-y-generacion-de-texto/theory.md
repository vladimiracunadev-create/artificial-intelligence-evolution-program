...
# Teoría — Clasificación, extracción y generación de texto
...
`Clasificación, extracción y generación de texto` se estudia como un sistema con:
...
Conceptos guía: **NLP, NER, clasificación, generación**.
