...
|---|---|---|---|
| Warden, P. y Situnayake, D. — *TinyML: Machine Learning with TensorFlow Lite on Arduino and Ultra-Low-Power Microcontrollers* | 2019 | _sin localizador verificado_ | citada en las referencias de esta clase |
