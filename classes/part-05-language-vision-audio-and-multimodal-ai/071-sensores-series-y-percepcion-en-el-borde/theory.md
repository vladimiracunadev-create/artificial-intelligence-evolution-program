...
# Teoría — Sensores, series y percepción en el borde
...
`Sensores, series y percepción en el borde` se estudia como un sistema con:
...
Conceptos guía: **sensores, edge, latencia, fusión**.
