...
# Teoría — Clasificación y representación visual
...
`Clasificación y representación visual` se estudia como un sistema con:
...
Conceptos guía: **visión, features, clasificación, augmentación**.
