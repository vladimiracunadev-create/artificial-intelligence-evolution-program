...
> [← Clase anterior](../../../classes/part-08-retrieval-context-memory-and-knowledge/098-segmentacion-metadatos-y-ventanas/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-08-retrieval-context-memory-and-knowledge/100-busqueda-hibrida-y-fusion-de-rankings/README.md)
...
siendo el complemento exacto de la vectorial (clase 097): encuentra identificadores,
nombres propios y términos raros que los embeddings difuminan. La clase 100 fusionará
...
la hibridación de la clase 100.
...
5. **Leer el score como probabilidad**. El score BM25 no está acotado ni calibrado; solo
   ...
   incorrecto (esto motiva RRF en la clase 100).
...
cuándo BM25 actúa solo, cuándo como candidato para re-ranking (clase 101) y cuándo
fusionado con lo denso (clase 100).
...
[098 — Segmentación, metadatos y ventanas](../../part-08-retrieval-context-memory-and-knowledge/098-segmentacion-metadatos-y-ventanas/README.md)
