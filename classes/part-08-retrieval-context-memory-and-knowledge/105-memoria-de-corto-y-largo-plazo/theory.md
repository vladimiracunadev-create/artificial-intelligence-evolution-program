...
# Teoría — Memoria de corto y largo plazo
...
`Memoria de corto y largo plazo` se estudia como un sistema con:
...
Conceptos guía: **memory, thread, store, episodic, semantic**.
