...
# Teoría — Transformación y descomposición de consultas
...
`Transformación y descomposición de consultas` se estudia como un sistema con:
...
Conceptos guía: **query rewrite, decomposition, routing, retrieval**.
