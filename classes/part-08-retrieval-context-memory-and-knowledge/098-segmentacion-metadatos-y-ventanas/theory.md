...
# Teoría — Segmentación, metadatos y ventanas
...
`Segmentación, metadatos y ventanas` se estudia como un sistema con:
...
Conceptos guía: **chunking, metadata, overlap, estructura**.
