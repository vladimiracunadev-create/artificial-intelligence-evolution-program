...
> [← Clase anterior](../../../classes/part-08-retrieval-context-memory-and-knowledge/101-re-ranking-y-filtros-de-evidencia/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-08-retrieval-context-memory-and-knowledge/103-transformacion-y-descomposicion-de-consultas/README.md)
...
3. Verificar después (clase 107): descomponer la respuesta en afirmaciones y comprobar
...
insuficiente, evaluación continua de fidelidad y cobertura (clase 107) y trazas que
permitan auditar meses después qué pasajes exactos produjeron cada respuesta (clase 108).
