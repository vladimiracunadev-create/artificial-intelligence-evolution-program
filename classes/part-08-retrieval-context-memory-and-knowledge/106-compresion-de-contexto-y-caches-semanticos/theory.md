...
# Teoría — Compresión de contexto y cachés semánticos
...
`Compresión de contexto y cachés semánticos` se estudia como un sistema con:
...
Conceptos guía: **compression, cache, context, budget**.
