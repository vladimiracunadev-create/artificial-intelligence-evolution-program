...
> [← Clase anterior](../../../classes/part-08-retrieval-context-memory-and-knowledge/108-memoria-de-corto-y-largo-plazo/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-08-retrieval-context-memory-and-knowledge/110-evaluacion-de-fidelidad-cobertura-y-atribucion/README.md)
...
de la respuesta?" — y medirla (clase 110) es lo único que legitima recortar. Esta
pregunta es el núcleo de lo que la industria llama hoy **context engineering** (el menor
conjunto de tokens de alta señal por llamada); la clase 118 la retoma para el caso
