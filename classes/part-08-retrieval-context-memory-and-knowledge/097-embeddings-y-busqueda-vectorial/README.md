...
> [← Clase anterior](../../../classes/part-07-generative-ai-across-media/096-proyecto-pipeline-creativo-trazable/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-08-retrieval-context-memory-and-knowledge/098-segmentacion-metadatos-y-ventanas/README.md)
...
1. **"Coseno alto = relevancia"**. El coseno mide similitud semántica de superficie;
   ...
   adicionales (clase 101, re-ranking).
