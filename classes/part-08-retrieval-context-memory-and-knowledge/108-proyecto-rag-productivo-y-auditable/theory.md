...
# Teoría — Proyecto: RAG productivo y auditable
...
`Proyecto: RAG productivo y auditable` se estudia como un sistema con:
...
Conceptos guía: **RAG, evals, observabilidad, seguridad**.
