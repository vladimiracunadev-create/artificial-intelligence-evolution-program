...
# 104 — Re-ranking y filtros de evidencia

> [← Clase anterior](../../../classes/part-08-retrieval-context-memory-and-knowledge/103-busqueda-hibrida-y-fusion-de-rankings/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../../classes/part-08-retrieval-context-memory-and-knowledge/105-rag-basico-con-citas/README.md)
...
La recuperación de las clases 100-103 optimiza el *recall*: traer candidatos plausibles
...
generador (clase 105) depende directamente de este filtro.

## 📖 Fundamentos

### ⚖️ Bi-encoder vs. cross-encoder

Un **bi-encoder** (como los modelos de embeddings de la clase 100) codifica consulta y
