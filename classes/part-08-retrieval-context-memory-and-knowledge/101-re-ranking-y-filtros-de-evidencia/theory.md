...
# Teoría — Re-ranking y filtros de evidencia
...
`Re-ranking y filtros de evidencia` se estudia como un sistema con:
...
Conceptos guía: **reranking, cross-encoder, filtros, calidad**.
