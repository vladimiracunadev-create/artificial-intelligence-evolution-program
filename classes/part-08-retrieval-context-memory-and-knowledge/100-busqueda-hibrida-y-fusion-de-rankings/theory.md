...
# Teoría — Búsqueda híbrida y fusión de rankings
...
`Búsqueda híbrida y fusión de rankings` se estudia como un sistema con:
...
Conceptos guía: **hybrid, RRF, sparse, dense**.
