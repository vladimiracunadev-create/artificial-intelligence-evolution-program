...
- `current`: adoptado y documentado, todavía evoluciona.
- `emerging`: señal relevante, requiere replicación.
- `deprecated`: se conserva como historia, no como recomendación.

La documentación derivada se regenera; no se mantienen conteos manuales
contradictorios.
