# 🎒 Ficha de estudio — P89 · Conjuntos difusos

> Generado por `python scripts/generate_papers.py`. Tu bitácora personal va en [`BITACORA.md`](BITACORA.md).

**Paper:** *Fuzzy Sets* (1965)
**Nivel:** L2 · **Notebook:** [`P89_fuzzy.ipynb`](../../notebooks/papers/P89_fuzzy.ipynb)

## En una frase

Permite que un elemento pertenezca parcialmente a un conjunto, y con eso da tratamiento formal a la vaguedad de los predicados del lenguaje.

## Ruta de trabajo (en este orden)

1. Lee la **pasada 1** de la ficha: título, resumen, figuras. 10 minutos, sin fórmulas.
2. Responde por escrito: *¿qué problema resolvía?* Compáralo con: «La teoría de conjuntos es binaria: algo pertenece o no pertenece. Pero «alto», «caliente» o «cerca» no tienen frontera nítida, y forzarlos a un umbral produce sistemas que cambian de decisión ante una diferencia irrelevante.»
...
[⬅️ Fichas de estudio](README.md) · [Ficha completa del paper](../../papers/foundational/P89_fuzzy/README.md)
