# 📝 Evaluación — P36 · Perdidos en el medio: cómo usan los modelos de lenguaje los contextos largos
...
**Paper:** *Lost in the Middle: How Language Models Use Long Contexts* (2023, arXiv:2307.03172 · TACL) · **Nivel:** L3
...
6. (10) Ejecuta [`P36_lost_in_middle.ipynb`](../../notebooks/papers/P36_lost_in_middle.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P36_lost_in_middle/README.md)
