# 📝 Evaluación — P133 · Los modelos de IA colapsan al entrenarse con datos generados recursivamente
...
**Paper:** *AI models collapse when trained on recursively generated data* (2024, Nature, 631, 755–759) · **Nivel:** L2
...
6. (10) Ejecuta [`P133_colapso_de_modelo.ipynb`](../../notebooks/papers/P133_colapso_de_modelo.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P133_colapso_de_modelo/README.md)
