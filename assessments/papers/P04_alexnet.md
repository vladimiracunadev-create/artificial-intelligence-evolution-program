...
**Paper:** *ImageNet Classification with Deep Convolutional Neural Networks* (2012, NeurIPS (NIPS) 2012) · **Nivel:** L3
...
6. (10) Ejecuta [`P04_alexnet.ipynb`](../../notebooks/papers/P04_alexnet.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P04_alexnet/README.md)
