# 📝 Evaluación — P103 · Aleatorización de dominio para transferir redes profundas de la simulación al mundo real
...
**Paper:** *Domain Randomization for Transferring Deep Neural Networks from Simulation to the Real World* (2017, IROS 2017, 23–30 · arXiv:1703.06907) · **Nivel:** L2
...
6. (10) Ejecuta [`P103_domain_randomization.ipynb`](../../notebooks/papers/P103_domain_randomization.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P103_domain_randomization/README.md)
