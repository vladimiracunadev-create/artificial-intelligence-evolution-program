# 📝 Evaluación — P96 · Un nuevo enfoque para los problemas de filtrado y predicción lineales
...
**Paper:** *A New Approach to Linear Filtering and Prediction Problems* (1960, Journal of Basic Engineering, 82(1), 35–45) · **Nivel:** L3
...
6. (10) Ejecuta [`P96_kalman.ipynb`](../../notebooks/papers/P96_kalman.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P96_kalman/README.md)
