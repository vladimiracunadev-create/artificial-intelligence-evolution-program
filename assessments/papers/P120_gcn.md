# 📝 Evaluación — P120 · Clasificación semisupervisada con redes convolucionales de grafo
...
**Paper:** *Semi-Supervised Classification with Graph Convolutional Networks* (2017, ICLR 2017 · arXiv:1609.02907) · **Nivel:** L2
...
6. (10) Ejecuta [`P120_gcn.ipynb`](../../notebooks/papers/P120_gcn.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P120_gcn/README.md)
