# 📝 Evaluación — P143 · Calibrar el ruido a la sensibilidad en el análisis privado de datos
...
**Paper:** *Calibrating Noise to Sensitivity in Private Data Analysis* (2006, TCC 2006, 265–284) · **Nivel:** L3
...
6. (10) Ejecuta [`P143_privacidad_diferencial.ipynb`](../../notebooks/papers/P143_privacidad_diferencial.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P143_privacidad_diferencial/README.md)
