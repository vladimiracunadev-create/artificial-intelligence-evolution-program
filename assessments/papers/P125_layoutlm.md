# 📝 Evaluación — P125 · LayoutLM: preentrenamiento de texto y disposición para comprensión de documentos
...
**Paper:** *LayoutLM: Pre-training of Text and Layout for Document Image Understanding* (2020, KDD 2020, 1192–1200) · **Nivel:** L2
...
6. (10) Ejecuta [`P125_layoutlm.ipynb`](../../notebooks/papers/P125_layoutlm.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P125_layoutlm/README.md)
