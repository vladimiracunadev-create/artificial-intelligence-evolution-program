# 📝 Evaluación — P97 · Un sistema de control por capas robusto para un robot móvil
...
**Paper:** *A Robust Layered Control System for a Mobile Robot* (1986, IEEE Journal of Robotics and Automation, 2(1), 14–23) · **Nivel:** L2
...
6. (10) Ejecuta [`P97_subsuncion.ipynb`](../../notebooks/papers/P97_subsuncion.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P97_subsuncion/README.md)
