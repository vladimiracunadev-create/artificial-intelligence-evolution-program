# 📝 Evaluación — P128 · NeRF: representar escenas como campos de radiancia neuronal
...
**Paper:** *NeRF: Representing Scenes as Neural Radiance Fields for View Synthesis* (2020, ECCV 2020, 405–421) · **Nivel:** L3
...
6. (10) Ejecuta [`P128_nerf.ipynb`](../../notebooks/papers/P128_nerf.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P128_nerf/README.md)
