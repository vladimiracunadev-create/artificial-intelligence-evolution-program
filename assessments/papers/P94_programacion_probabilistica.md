# 📝 Evaluación — P94 · Stan: un lenguaje de programación probabilística
...
**Paper:** *Stan: A Probabilistic Programming Language* (2017, Journal of Statistical Software, 76(1)) · **Nivel:** L3
...
6. (10) Ejecuta [`P94_programacion_probabilistica.ipynb`](../../notebooks/papers/P94_programacion_probabilistica.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P94_programacion_probabilistica/README.md)
