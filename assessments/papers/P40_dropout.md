# 📝 Evaluación — P40 · Dropout: una forma simple de evitar el sobreajuste en redes neuronales
...
6. (10) Ejecuta [`P40_dropout.ipynb`](../../notebooks/papers/P40_dropout.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P40_dropout/README.md)
