# 📝 Evaluación — P132 · Splatting de gaussianas 3D para renderizado de campos de radiancia en tiempo real
...
**Paper:** *3D Gaussian Splatting for Real-Time Radiance Field Rendering* (2023, ACM Transactions on Graphics, 42(4)) · **Nivel:** L3
...
6. (10) Ejecuta [`P132_gaussian_splatting.ipynb`](../../notebooks/papers/P132_gaussian_splatting.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P132_gaussian_splatting/README.md)
