# 📝 Evaluación — P118 · Traducción automática neuronal de palabras raras con unidades de subpalabra
...
**Paper:** *Neural Machine Translation of Rare Words with Subword Units* (2016, ACL 2016, 1715–1725) · **Nivel:** L2
...
6. (10) Ejecuta [`P118_bpe.ipynb`](../../notebooks/papers/P118_bpe.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P118_bpe/README.md)
