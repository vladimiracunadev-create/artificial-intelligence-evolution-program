# 📝 Evaluación — P90 · Algoritmos genéticos y la asignación óptima de ensayos
...
**Paper:** *Genetic Algorithms and the Optimal Allocation of Trials* (1973, SIAM Journal on Computing, 2(2), 88–105) · **Nivel:** L2
...
6. (10) Ejecuta [`P90_algoritmos_geneticos.ipynb`](../../notebooks/papers/P90_algoritmos_geneticos.ipynb) con **tres semillas**
...
[⬅️ Evaluaciones del eje](README.md) · [Ficha](../../papers/foundational/P90_algoritmos_geneticos/README.md)
