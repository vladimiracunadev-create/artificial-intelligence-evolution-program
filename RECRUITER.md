...
- 174 motores didácticos reutilizables con contratos uniformes
  (26 de clases + 148 de papers), deterministas y sin dependencias;
...
4. `src/ai_evolution/papers_lab.py` — 148 mecanismos en Python estándar
