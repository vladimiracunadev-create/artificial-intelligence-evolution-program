...
|---|---|
| Modelo | transforma entrada en salida |
| Prompt | configura una interacción |
| Resource | aporta contexto consultable |
| Tool | ejecuta una operación acotada |
| Skill | empaqueta instrucciones y recursos reutilizables |
| Workflow | fija una secuencia y condiciones |
...
- Parte 11: acciones sobre computador y mundo físico.
...
Un pipeline determinista puede ser valioso, pero debe llamarse workflow.
